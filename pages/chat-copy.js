          ...
          <nav className="flex h-9 items-center justify-between" aria-label="Global">
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 fill-cyan-500">
        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
              ...
              <div className="overflow-hidden bg-white shadow sm:rounded-lg mt-40">
                ...
                <article class="prose lg:prose-xl py-10 pb-2">
                  ...
                  <pre contenteditable="true">
                    <p className="text-base">Visualiza el código aquí 👇</p>
